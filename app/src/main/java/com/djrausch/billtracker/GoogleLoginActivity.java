...
public class GoogleLoginActivity extends MvpActivity<GoogleLoginView, GoogleLoginPresenter> implements GoogleApiClient.OnConnectionFailedListener, GoogleLoginView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GoogleSignInOptions gso = new GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
                .requestEmail()
                .requestIdToken("345474014106-6ev3hllohtecuofvoa7q9bbrd8piv50o.apps.googleusercontent.com")
                .build();
    ...
    private void handleSignInResult(GoogleSignInResult result) {
        ...
        if (result.isSuccess()) {
            ...
            //TODO Error
            Log.d("error", GoogleSignInStatusCodes.getStatusCodeString(result.getStatus().getStatusCode()));
        }
    }
